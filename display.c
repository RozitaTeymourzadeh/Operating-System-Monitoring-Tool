/*
Program: Display.c
Description: To display content on the shell terminal (Utility)
...
void display_refresh(char *procfs_loc)
{
    ...
    //char vers[32] = "";
    char *vers = calloc(1024, sizeof(char));
    ...
    char *uptime_str = calloc(1024, sizeof(char));
    if (uptime == 0.0) {
